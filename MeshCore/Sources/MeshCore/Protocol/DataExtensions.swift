...
public extension Data {
  ...
  func readUInt32LE(at offset: Int) -> UInt32 {
    ...
    return dropFirst(offset).withUnsafeBytes {
...
public extension Data {
  ...
  func paddedOrTruncated(to length: Int) -> Data {
  ...
  func decodingLongestValidUTF8Prefix() -> String {
...
public extension String {
  ...
  func utf8PaddedOrTruncated(to length: Int) -> Data {
