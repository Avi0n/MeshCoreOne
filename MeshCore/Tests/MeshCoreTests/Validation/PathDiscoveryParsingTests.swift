...
struct PathDiscoveryParsingTests {
    ...
    @Test("pathDiscoveryResponse preserves mode-1 out_path_len byte")
    func pathDiscoveryResponsePreservesMode1PathLength() {
    ...
    @Test("pathDiscoveryResponse preserves mode-2 out_path_len byte")
    func pathDiscoveryResponsePreservesMode2PathLength() {
    ...
    @Test("pathDiscoveryResponse preserves both out and in length bytes")
    func pathDiscoveryResponsePreservesBothInAndOut() {
    ...
    @Test("pathDiscoveryResponse outHopCount is nil for reserved mode")
    func pathDiscoveryResponseReservedModeYieldsNilHopCount() {
