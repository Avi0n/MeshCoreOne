...
struct V115SessionMethodsTests {
  @Test
  func `sendChannelData emits correct frame and awaits OK`() async throws {
  ...
  @Test
  func `sendChannelData throws deviceError on error response`() async throws {
    let transport = MockTransport()
    let session = MeshCoreSession(
      transport: transport,
      configuration: SessionConfiguration(defaultTimeout: 10, clientIdentifier: "MCTst")
  ...
  @Test
  func `sendChannelData forwards pathLength and pathBytes to the builder`() async throws {
  ...
  @Test
  func `setDefaultFloodScope with name and key`() async throws {
    let transport = MockTransport()
    let session = MeshCoreSession(
      transport: transport,
      configuration: SessionConfiguration(defaultTimeout: 10, clientIdentifier: "MCTst")
  ...
  @Test
  func `setDefaultFloodScope clears with empty args`() async throws {
    let transport = MockTransport()
    let session = MeshCoreSession(
      transport: transport,
      configuration: SessionConfiguration(defaultTimeout: 10, clientIdentifier: "MCTst")
  ...
  @Test
  func `setDefaultFloodScope FloodScope overload — disabled clears`() async throws {
  ...
  @Test
  func `setDefaultFloodScope FloodScope overload — channelName derives key`() async throws {
  ...
  @Test
  func `getDefaultFloodScope returns populated scope`() async throws {
    let transport = MockTransport()
    let session = MeshCoreSession(
      transport: transport,
      configuration: SessionConfiguration(defaultTimeout: 10, clientIdentifier: "MCTst")
  ...
  @Test
  func `getDefaultFloodScope returns nil when empty`() async throws {
    let transport = MockTransport()
    let session = MeshCoreSession(
      transport: transport,
      configuration: SessionConfiguration(defaultTimeout: 10, clientIdentifier: "MCTst")
  ...
  @Test
  func `getDefaultFloodScope propagates device errors`() async throws {
  ...
  @Test
  func `sendTrace throws invalidInput when path is nil`() async throws {
    let transport = MockTransport()
    let session = MeshCoreSession(
      transport: transport,
      configuration: SessionConfiguration(defaultTimeout: 10, clientIdentifier: "MCTst")
  ...
  @Test
  func `sendTrace throws invalidInput when path is empty`() async throws {
    let transport = MockTransport()
    let session = MeshCoreSession(
      transport: transport,
      configuration: SessionConfiguration(defaultTimeout: 10, clientIdentifier: "MCTst")
