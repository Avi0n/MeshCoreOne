...
struct Ed25519ToX25519Tests {
  ...
  @Test
  func `Public key conversion round-trip with CryptoKit`() throws {
  ...
  @Test
  func `DM decrypt with converted Ed25519 keys`() throws {
    ...
    while plaintext.count < paddedLen {
      plaintext.append(0)
    }
  ...
  @Test
  func `Conversion rejects invalid inputs`() {
