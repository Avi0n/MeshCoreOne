...
struct BackupUserDefaultsCoverageTests {
  @Test
  func `Every Bool? property has a boolMappings row`() {
    let propertyNames = optionalPropertyNames(matching: Bool?.self)
  ...
  @Test
  func `Every String? property has a stringMappings row`() {
    let propertyNames = optionalPropertyNames(matching: String?.self)
  ...
  @Test
  func `Every Optional property is covered by a mapping or special-cased`() {
