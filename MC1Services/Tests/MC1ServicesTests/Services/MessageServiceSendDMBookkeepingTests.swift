...
struct MessageServiceSendDMBookkeepingTests {
    ...
    @Test("sendDirectMessage keeps ACK tracking and does not report failure when post-send bookkeeping fails")
    @MainActor
    func postSendBookkeepingFailureKeepsPendingAck() async throws {
