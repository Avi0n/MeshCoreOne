...
struct DebugLogBufferTests {
    ...
    @Test("shared get and set round-trip through the lock")
    ...
    @Test("concurrent reads and writes of shared are race-free")
    func concurrentAccessIsRaceFree() async throws {
