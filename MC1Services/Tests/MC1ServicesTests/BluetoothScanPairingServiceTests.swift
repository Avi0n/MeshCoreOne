...
struct BluetoothScanPairingServiceTests {
  @Test
  func `discoverDevice presents the picker and resolves with the selected id`() async throws {
  ...
  @Test
  func `cancel surfaces DevicePairingError.cancelled and lowers presentation`() async throws {
    let service = BluetoothScanPairingService()
  ...
  @Test
  func `a new discovery resolves a stranded prior discovery`() async throws {
    let service = BluetoothScanPairingService()
  ...
  @Test
  func `cancelling the discovery task resolves it and lowers presentation`() async throws {
    let service = BluetoothScanPairingService()
  ...
  @Test
  func `a selection racing a cancelled discovery task surfaces cancelled, not the selection`() async throws {
    let service = BluetoothScanPairingService()
  ...
  @Test
  func `system-registry operations are inert on the macOS path`() async throws {
    let service = BluetoothScanPairingService()
