...
struct KnownRegionTests {
  ...
  @Test
  func `addDeviceKnownRegion finds device by radioID, not by id`() async throws {
  ...
  @Test
  func `addDeviceKnownRegion does not duplicate existing region`() async throws {
    let store = try await createTestStore()
  ...
  @Test
  func `addDeviceKnownRegion throws when device not found`() async throws {
    let store = try await createTestStore()
  ...
  @Test
  func `removeDeviceKnownRegion clears region and channel regionScope`() async throws {
    let store = try await createTestStore()
  ...
  @Test
  func `removeDeviceKnownRegion leaves unrelated channel regionScope intact`() async throws {
    let store = try await createTestStore()
  ...
  @Test
  func `removeDeviceKnownRegion throws when device not found`() async throws {
    let store = try await createTestStore()
  ...
  @Test
  func `Full saveDevice does not clobber regions added via the targeted path`() async throws {
    let store = try await createTestStore()
