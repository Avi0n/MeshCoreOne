...
private let radioLogger = PersistentLogger(subsystem: "com.mc1", category: "radio")
...
public enum RadioOptions {
  ...
  public static let bandwidthsHz: [UInt32] = [
    7800, 10400, 15600, 20800, 31250, 41700, 62500, 125_000, 250_000, 500_000
  ]
  ...
  public static func formatBandwidth(_ hz: UInt32) -> String {
    switch hz {
    case 7800: return "7.8"
    case 10400: return "10.4"
    case 15600: return "15.6"
    case 20800: return "20.8"
    case 31250: return "31.25"
    case 41700: return "41.7"
    case 62500: return "62.5"
