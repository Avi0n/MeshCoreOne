...
extension PersistenceStore {
    ...
    func fetchAllMessagesForBackup() throws -> [MessageDTO] {
    ...
    public func fetchAllMessageRepeats(messageIDs: Set<UUID>) throws -> [MessageRepeatDTO] {
    ...
    public func fetchAllRoomMessages(sessionIDs: Set<UUID>) throws -> [RoomMessageDTO] {
    ...
    public func fetchAllNodeStatusSnapshots() throws -> [NodeStatusSnapshotDTO] {
    ...
    func fetchBackupExportSnapshot() throws -> BackupExportSnapshot {
