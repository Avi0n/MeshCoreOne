...
public final class StoreService {
  ...
  var appStoreSyncForTesting: (@Sendable () async throws -> Void)?
  ...
  private nonisolated func observeTransactionUpdates() async {
  ...
  private func noteUnverified(_ result: VerificationResult<Transaction>) {
    guard case let .unverified(transaction, error) = result else { return }
