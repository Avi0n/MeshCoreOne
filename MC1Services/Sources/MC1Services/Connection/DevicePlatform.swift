...
enum DevicePlatform {
  ...
  var recommendedWritePacing: TimeInterval {
    switch self {
    case .esp32: 0.060 // 60ms required by ESP32 BLE stack
    case .nrf52: 0.025 // Light pacing to avoid RX queue pressure
    case .unknown: 0.060 // Conservative ESP32-safe default for unrecognized devices
    }
  }
