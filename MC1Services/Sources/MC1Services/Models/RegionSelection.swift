...
public struct RegionSelection: Codable, Sendable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.administrativeAreaCode = try c.decodeIfPresent(String.self, forKey: .administrativeAreaCode)
        self.countyKey = try c.decodeIfPresent(String.self, forKey: .countyKey)
