...
enum AvatarCategory: Sendable {
    ...
    var gamutSeed: String {
        switch self {
        case .channel: return "__avatar_category_channel__"
        case .repeater: return "__avatar_category_repeater__"
        case .room: return "__avatar_category_room__"
        }
    }
}
