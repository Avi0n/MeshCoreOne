...
///   `taskCompleted(generation:)` then respawns the drain so the requeued
///   envelope retries. This covers send closures that honour cancellation
///   internally (e.g., `try Task.checkCancellation()` inside a service call).
