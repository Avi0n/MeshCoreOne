...
struct AddHopPickerView: View {
  ...
  private var showsDiscovered: Bool {
    filter == .all || filter == .discovered
  }

  private var showsRooms: Bool {
    filter == .all
  }
...
private struct BulkCodeRow: View {
  ...
  private var iconName: String? {
    switch classification.status {
    case .willAdd: nil
    case .alreadyInPath: "checkmark.circle.fill"
    case .notFound: "questionmark.circle"
    case .invalidFormat: "exclamationmark.triangle.fill"
    case .pathFull: "nosign"
    }
  }
  ...
  private var iconTint: Color? {
    switch classification.status {
    case .willAdd: nil
    case .alreadyInPath: .secondary
    case .notFound: .orange
    case .invalidFormat: .red
    case .pathFull: .secondary
    }
  }
}
