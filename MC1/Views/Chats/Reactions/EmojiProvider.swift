...
struct EmojiCategoryData: Identifiable {
  ...
  var localizedName: String {
    switch id {
    case "frequent":
      L10n.Chats.Reactions.Emoji.Category.frequent
    case EmojibaseCategory.people.rawValue:
      L10n.Chats.Reactions.Emoji.Category.people
    case EmojibaseCategory.nature.rawValue:
      L10n.Chats.Reactions.Emoji.Category.nature
    case EmojibaseCategory.foods.rawValue:
      L10n.Chats.Reactions.Emoji.Category.foods
    case EmojibaseCategory.activity.rawValue:
      L10n.Chats.Reactions.Emoji.Category.activity
    case EmojibaseCategory.places.rawValue:
      L10n.Chats.Reactions.Emoji.Category.places
    case EmojibaseCategory.objects.rawValue:
      L10n.Chats.Reactions.Emoji.Category.objects
    case EmojibaseCategory.symbols.rawValue:
      L10n.Chats.Reactions.Emoji.Category.symbols
    case EmojibaseCategory.flags.rawValue:
      L10n.Chats.Reactions.Emoji.Category.flags
    default:
      id.capitalized
    }
  }
...
final class EmojiProvider {
  ...
  @ObservationIgnored
  @AppStorage(AppStorageKey.frequentEmojis.rawValue) private var frequentEmojisData: Data = .init()
