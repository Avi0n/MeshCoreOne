...
struct MessageLinkTokenizerTests {
  ...
  @Test
  func `URL detector emits a url token`() {
  ...
  @Test
  func `Hashtag detector emits a bold, non-underlined token`() {
  ...
  @Test
  func `MeshCore link detector emits a meshcore token and trims trailing punctuation`() {
  ...
  @Test
  func `MeshCore link with a non-contact, non-channel host is ignored`() {
  ...
  @Test
  func `Coordinate detector emits a coordinate token`() {
  ...
  @Test
  func `A pre-pass mention span outranks a URL detection over the same characters`() {
  ...
  @Test
  func `The merged token stream is sorted and non-overlapping`() {
  ...
  @Test
  func `A hashtag inside a URL is excluded via the shared URL ranges`() {
  ...
  @Test
  func `A hashtag inside a meshcore link wins the overlap and the meshcore link is dropped`() {
  ...
  @Test
  func `A hashtag inside a meshcore contact link also wins the overlap and drops the link`() {
  ...
  @Test
  func `mapCoordinate is the first surviving coordinate in document order`() {
  ...
  @Test
  func `mapCoordinate skips a coordinate that lost to a higher-priority token`() {
  ...
  @Test
  func `No coordinate yields a nil mapCoordinate`() {
  ...
  @Test
  func `A coordinate token URL round-trips through MeshCoreURLParser with dot-decimals`() throws {
