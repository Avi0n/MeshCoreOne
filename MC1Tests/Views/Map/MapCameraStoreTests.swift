...
struct MapCameraStoreTests {
  @Test
  func `encode then decode round-trips a region`() throws {
  ...
  @Test
  func `decode rejects a region that encode produced from invalid input`() {
  ...
  func `decode rejects malformed input`(_ input: String) {
